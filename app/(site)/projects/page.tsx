...
export default function Projects() {
  return (
    <div id="projects" className="pt-12">
      ...
      <div className=" projectsx bg-gray-100  w-full h-full ">
          ...
          <div>
            ...
            <dl className="mt-16 grid grid-cols-1 gap-x-6 gap-y-10 sm:grid-cols-2 sm:gap-y-16 lg:gap-x-8 ">
              ...
              <div className="border-t border-gray-200 pt-4">
                ...
                <dd className="mt-2 text-sm text-gray-500">
                  Our expertise extends across various industries, reflecting
                  our ability to cater to diverse client needs. By demonstrating
                  adaptability and innovation, we showcased our capacity to
                  deliver tailored solutions that drive success in central
                  kitchen environments of all kinds.
                </dd>
              </div>
            </dl>
          </div>
